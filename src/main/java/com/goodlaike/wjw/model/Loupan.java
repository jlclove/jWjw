...
public class Loupan implements Serializable {
	...
	public int getStructFuctions() {
		return this.structFuctions;
	}

	public void setStructFuctions(int structFuctions) {
		this.structFuctions = structFuctions;
	}
	...
	public String toString() {
		return "Loupan [id=" + id + ", name=" + name + ", cityName=" + cityName + ", districtName=" + districtName
				+ ", avgPrice=" + avgPrice + ", address=" + address + ", statFunctions=" + statFunctions
				+ ", structFuctions=" + structFuctions + ", decoItems=" + decoItems + ", ageLimits=" + ageLimits
				+ ", developerName=" + developerName + ", traffic=" + traffic + ", equipment=" + equipment
				+ ", siteArea=" + siteArea + ", buildArea=" + buildArea + ", ratio=" + ratio + ", greenRate="
				+ greenRate + ", carRate=" + carRate + ", buildingCnt=" + buildingCnt + ", roomCnt=" + roomCnt
				+ ", propertyFee=" + propertyFee + ", propertyName=" + propertyName + ", description=" + description
				+ ", linkerPhone=" + linkerPhone + ", status=" + status + ", creator=" + creator + ", createTime="
